const CACHE="resenhaflix-shell-v54";
const SHELL=["./","./index.html","./app.js?v=53","./manifest.webmanifest","./manga-hakuneko.css?v=34","./manga-hakuneko.js?v=34","./ui-polish.js?v=50","./theme-v54.css?v=54","./icons/resenhaflix-logo.png?v=54","./icons/icon-192.png?v=54","./icons/icon-512.png?v=54","./icons/icon-maskable-512.png?v=54"];
