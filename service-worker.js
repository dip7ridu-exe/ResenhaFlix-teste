const CACHE="resenhaflix-shell-v34";
const SHELL=["./","./index.html","./manifest.webmanifest","./manga-hakuneko.css?v=34","./manga-hakuneko.js?v=34","./icons/resenhaflix-logo.png","./icons/icon-192.png","./icons/icon-512.png","./icons/icon-maskable-512.png"];
