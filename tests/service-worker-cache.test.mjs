...
assert.deepEqual(deleted.sort(), ["resenhaflix-shell-v34", "resenhaflix-shell-v50", "resenhaflix-shell-v51", "resenhaflix-shell-v52", "resenhaflix-shell-v53", "resenhaflix-shell-v54", "resenhaflix-shell-v55", "resenhaflix-shell-v56", "resenhaflix-shell-v57", "resenhaflix-shell-v58", "resenhaflix-shell-v59"]);
assert.equal(claimed, true);
assert.equal(deleted.includes("outro-projeto-cache"), false, "activation must preserve unrelated GitHub Pages caches");

console.log("service worker v60: cleanup is restricted to ResenhaFlix shell caches");
