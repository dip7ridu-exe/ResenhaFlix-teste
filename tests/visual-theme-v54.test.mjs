...
const playerIndex = html.indexOf('./player-v55.css?v=57');
assert.ok(uiPolishIndex >= 0 && themeIndex > uiPolishIndex && playerIndex > themeIndex, "v57 player theme must load last");
...
console.log("visual v57: original palette, local SVG controls and full-screen player OK");
